#
#  Be sure to run `pod spec lint ZuperChecklist.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/sabarics/ZuperChecklist"
  ...
  spec.source       = { :git => "https://github.com/sabarics/ZuperChecklist.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "ZuperChecklist/**/*.{h,m,swift}"
  ...
  spec.resources = 'ZuperChecklist/**/*.{png,storyboard,xib,xcassets}'
